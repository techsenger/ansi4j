 ...
 */
class VisibilitySample extends AbstractAttributeSample<Boolean> {

    VisibilitySample(Boolean defaultValue, Boolean currentValue, boolean supportedInWebView,
    ...
    public Attribute<Boolean> resolveAttribute(TextAttributeGroup group) {
        return group.getVisibilityAttribute();
    }
}
