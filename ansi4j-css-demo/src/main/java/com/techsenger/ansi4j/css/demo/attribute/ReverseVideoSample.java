 ...
 */
class ReverseVideoSample extends AbstractAttributeSample<Boolean> {

    ReverseVideoSample(Boolean defaultValue, Boolean currentValue, boolean supportedInWebView,
    ...
    public Attribute<Boolean> resolveAttribute(TextAttributeGroup group) {
        return group.getReverseVideoAttribute();
    }
