 ...
 */
class ItalicSample extends AbstractAttributeSample<Boolean> {

    ItalicSample(Boolean defaultValue, Boolean currentValue, boolean supportedInWebView,
    ...
    public Attribute<Boolean> resolveAttribute(TextAttributeGroup group) {
        return group.getItalicAttribute();
    }
}
